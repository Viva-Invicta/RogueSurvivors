...
namespace DunDungeons
{
    public abstract class CharacterBehaviourController : MonoBehaviour, IHaveFaction
    {
        ...
        [SerializeField] protected CharacterSkillsController skillsController;
        ...
        public void Initialize(ServiceLocator serviceLocator)
        {
            ...
            if (skillsController)
            {
                skillsController.SkillUseCompleted += HandleSkillUsageCompleted;
            }
        ...
        {
            if (skillsController.TryUseSkill())
            {
                state.IsAttackLocked = true;
                state.IsDashLocked = true;

                animationController.SetWalking(false);
                animationController.SetAnimationByKey(skillsController.ActiveSkill.Configuration.Animation, true);
            }   
        }
        ...
        private void HandleSkillUsageCompleted()
        {
            ...
            state.IsDashLocked = false;

            animationController.SetAnimationByKey(skillsController.ActiveSkill.Configuration.Animation, false);
        }
    }
}